...
const DropdownUser = () => {
  ...
  // ---- handlilng ogout functinality here ----
    ...
    <div className="relative">
      ...
      >
        ...
        <div>
          {/* <button
            type="button"
            className="bg-blue-700 hover:bg-blue-800 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mr-2 mb-2 rounded-full px-5 py-2.5 text-center text-sm font-medium text-white focus:outline-none focus:ring-4"
          >
            Default
          </button> */}
        </div>
