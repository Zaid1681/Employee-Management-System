  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-1 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      ...
      <div className="flex flex-col text-center">
        <div className="grid w-[100%] rounded-sm bg-gray-2  dark:bg-meta-4 sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-11">
        ...
        {data.map((item: any, index: any) => (
          <div
            key={index}
            className="grid grid-cols-11 border-b border-stroke dark:border-strokedark "
          >
            <div className="flex items-center    p-1 xl:p-3">
              ...
              <div className="w-[10% ] flex items-center justify-center p-1 xl:p-3">
